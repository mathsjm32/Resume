...
**3. 가계동향조사 기반 소득분위 계층별 소비구조 추세 분석 | 2026.06 ~ 2026.07**
- 단일 평균 통계의 한계를 극복하고자 29개 분기 동안의 국가데이터처 가계동향조사(MDIS) 및 지출목적별/품목별 소비자물가지수(KOSIS) 데이터를 활용하여, 물가와 경기 충격이 소득 5분위 계층별 소비구조의 변화와 지출 격차에 미친 실질적인 영향을 추세 분석하였습니다.
